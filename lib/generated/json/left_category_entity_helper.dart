...
leftCategoryEntityFromJson(LeftCategoryEntity data, Map<String, dynamic> json) {
	if (json['errno'] != null) {
		data.errno = json['errno']?.toInt();
	}
	if (json['data'] != null) {
		data.data = new List<LeftCategoryData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new LeftCategoryData().fromJson(v));
		});
	}
	if (json['errmsg'] != null) {
...
Map<String, dynamic> leftCategoryEntityToJson(LeftCategoryEntity entity) {
...
leftCategoryDataFromJson(LeftCategoryData data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> leftCategoryDataToJson(LeftCategoryData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
